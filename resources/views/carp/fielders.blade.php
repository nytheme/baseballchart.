    ...
    <script>
      ...
      var option = {
        ...
        xAxis : [
            {
                type : 'category',
                data : ['<?php print_r($hrs_names[0]); ?>','<?php print_r($hrs_names[1]); ?>','<?php print_r($hrs_names[2]); ?>','<?php print_r($hrs_names[3]); ?>','<?php print_r($hrs_names[4]); ?>','<?php print_r($hrs_names[5]); ?>','<?php print_r($hrs_names[6]); ?>','<?php print_r($hrs_names[7]); ?>','<?php print_r($hrs_names[8]); ?>','<?php print_r($hrs_names[9]); ?>'],
                axisTick: {
                    alignWithLabel: true
                },
                axisLabel: {
        ...
        series : [
            {
                ...
                type:'bar',
                barWidth: '50%',
                data:['<?php print_r($hrs[0]); ?>','<?php print_r($hrs[1]); ?>','<?php print_r($hrs[2]); ?>','<?php print_r($hrs[3]); ?>','<?php print_r($hrs[4]); ?>','<?php print_r($hrs[5]); ?>','<?php print_r($hrs[6]); ?>','<?php print_r($hrs[7]); ?>','<?php print_r($hrs[8]); ?>','<?php print_r($hrs[9]); ?>',],
                label: {
                        normal: {
                            show: true,
                            position: 'insideTop'
      ...
      var option = {
        ...
        yAxis: {
            type: 'category',
            data: ['<?php print_r($hrs_names[9]); ?>','<?php print_r($hrs_names[8]); ?>','<?php print_r($hrs_names[7]); ?>','<?php print_r($hrs_names[6]); ?>','<?php print_r($hrs_names[5]); ?>','<?php print_r($hrs_names[4]); ?>','<?php print_r($hrs_names[3]); ?>','<?php print_r($hrs_names[2]); ?>','<?php print_r($hrs_names[1]); ?>','<?php print_r($hrs_names[0]); ?>']
        },
        series: [
            {
                name: '',
